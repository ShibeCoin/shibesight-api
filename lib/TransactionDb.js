...
var CONCURRENCY = 10;
var DEFAULT_SAFE_CONFIRMATIONS = 3;
...
var encodedData = require('soop').load('shibecore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('shibecore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('shibecore/lib/Address', {
